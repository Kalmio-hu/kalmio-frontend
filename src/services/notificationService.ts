...
export const notificationService = {
  ...
  snooze: (slotId: string): Promise<NotificationPreferences> =>
    api.post<NotificationPreferences>(`/api/notifications/snooze/${slotId}`).then(r => r.data),
  ...
  quietToday: (): Promise<NotificationPreferences> =>
    api.post<NotificationPreferences>('/api/notifications/quiet-today').then(r => r.data),
  ...
  resumeNotifications: (): Promise<void> =>
    api.delete('/api/notifications/quiet-today').then(() => undefined),
